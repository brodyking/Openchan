...
if ($uploadOk == 0) {
    file_put_contents($db,'<table id="' . file_get_contents('postcount.txt') . '"><tr><td class="top"><span class="left"><b>'.$_POST["sendername"].'</b> <pt>#'. file_get_contents('postcount.txt') . '</pt></span><span class="right"> ' . date("m-d-y") . ' ' . date("h:i a") . ' </span></b></td></tr><tr><td>' . htmlentities($_POST['content']) . '</td></tr></table>' . file_get_contents($db));
    
    // Overchan database
    file_put_contents('../overchan/database.html','<table><tr><td class="top"><span class="left"><a class="highlight overchanlink" href="../' . $bn . '">/' . $bn . '/</a> <b>'.$_POST["sendername"].'</b>  <pt>#'. file_get_contents('postcount.txt') . '</pt></span><span class="right"> ' . date("m-d-y") . ' ' . date("h:i a") . ' </span></b></td></tr><tr><td>' . htmlentities($_POST['content']) . '</td></tr></table>' . file_get_contents('../overchan/database.html'));
